...
Teacher: _____________________<br><br>
AUTOMOBILE TO BE REPAIRED<br>
<table style="width:100%">
  <tr>
    <td>Year:_____</td>
    <td>Make: __________</td>
    <td>Model:____________</td>
  </tr>
  <tr>
    <td>VIN #:______________</td>
    <td>License Plate:_________________</td>
    <td>Odometer:___________</td>
  </tr>
</table>
<br><br>
...
Date on which the work shall be completed:___________<br><br>
...
Date of estimate:__________________________________<br>
This estimate expires on:_____________________________<br><br>
Any parts removed in the course of work on or repairs to the automobile shall be (select one):
(A) returned to the undersigned ______; or (B) disposed of by the School_______<br><br>
